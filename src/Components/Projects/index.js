...
function Projects() {
    ...
    return (
        <div>
            <div className="projects-container p-5 row g-0 justify-content-evenly">
                {projects.map((proj, i) => (
            ...
            <Modal dialogClassName='modal-xl' contentClassName='bg-blue text-light' show={isShow}>
                ...
                <Modal.Footer className='d-flex justify-content-center'>
                    <a href={`${currentProj.link}`} className='text-decoration-none text-dark fw-bold btn bg-dark-yellow ' >
                        Checkout More
                    </a>
